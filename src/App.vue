...
<style lang="scss">
$White:rgba(255,255,255,0.5)!important;
$Black:rgba(0,0,0,0.5)!important;
$Color:#fff!important;
...
.el-table th, .el-table tr,.el-table, .el-table__expanded-cellhi {
  background:$White;
  //color:$Color;
}
...
.el-radio__input.is-checked+.el-radio__label ,.el-radio{
  color:$Color;
}
.el-form-item__label {
  color:$Color
